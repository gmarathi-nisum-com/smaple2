      ...
      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12" style={{textAlign:'center', backgroundColor: "#fff"}}>
        <div className="container">
            <div className="page-header" style={{border: 'none'}}> 
              <h1>OUR TERMS OF USE AND PRIVACY POLICY...</h1> 
              <h3>Our Terms of Use, Privacy and Grievance Policies are elaborated here for your reference.</h3>  
            </div>
          </div>
        </div>
        
        <div>
           <imports.Tabs onChange={this.handleChange} value={this.state.slideIndex}>
            <imports.Tab 
...
export default connect(mapStateToProps, actionsToProps)(Policy);
